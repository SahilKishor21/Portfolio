    ...
    <>
      ...
      >
        <div className="flex items-center justify-center mb-6">
          ...
          <a
            className="inline-block mx-2"
            href="https://linkedin.com/in/45-sahil"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div className="hidden  md:flex items-center justify-center mb-6 flex-wrap">
          <a
            ...
            href="https://app.daily.dev/lazygeek?userid=acVncZROFdZFXTp7UHk8b&cid=share_profile"
            target="_blank"
            rel="noopener noreferrer"
          >
            Fiverr
          ...
          <a
            className="text-xl inline-bloc mx-6 text-neutral"
            href="https://dribbble.com/sahil_kishor"
            target="_blank"
            rel="noopener noreferrer"
          >
            Dribbble
