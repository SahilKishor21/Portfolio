    ...
    <div className="parent pt-16 my-16">
      <div className="">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          >
            <img
              src="https://res.cloudinary.com/djqkofsv0/image/upload/v1734737570/Me_tt0pxv.jpg"
              alt="Sahil"
          ...
          >
            <h1 className="text-4xl font-semibold mb-4 text-center translate-y-[-380%] sm:translate-y-[-0%] sm:text-3xl sm:mb-2 md:text-left">Sahil Kishor</h1>
            <div className="my-8">
              <TypeAnimation
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-4 mt-4 text-center translate-y-[-50%] sm:translate-y-[-0%] sm:mb-2 md:text-left ">
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Name : </span>Sahil Kishor
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Phone : </span>+91 7562007896
              </h2>
              <h2 className="font-medium">
                <span className="mr-2 text-primary">Email : </span>
                Sahilkishor8@gmail.com
              </h2>
              <h2 className="font-medium">
